...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="addContact.jsp"><i class="fa-solid fa-plus"></i> Add Phone</a>
      </li>
       <li class="nav-item active">
    ...
    if (user != null) {%>
        <form class="form-inline my-2 my-lg-0">
             <button class="btn btn-success">Welcome, <i class="fa-solid fa-user"></i> <%= user.getName()%></button>
             <a  data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-danger ml-2 text-white">Logout</a>
        </form>
    <%}else{%>
        <form class="form-inline my-2 my-lg-0">
            <a href="login.jsp" class="btn btn-success"><i class="fa-solid fa-user-tie"></i> Login</a>
            <a href="register.jsp" class="btn btn-danger ml-2"><i class="fa-solid fa-user-tie"></i> Register</a>
        </form>
    <%}%>        
  </div>
  <!--Logout popup-->
